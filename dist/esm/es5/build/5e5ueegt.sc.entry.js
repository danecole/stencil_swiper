...
import { h } from '../dc-swiper.core.js';
/**
 * SSR Window 1.0.1
    ...
    prependSlide: function (slides) {
        ...
        if (swiper.params.virtual.cache) {
            ...
            Object.keys(cache_1).forEach(function (cachedIndex) {
                newCache_1[parseInt(cachedIndex, 10) + numberOfNewSlides] = cache_1[cachedIndex];
            });
...
var DcSwiper = /** @class */ (function () {
    function DcSwiper() {
    }
    DcSwiper.prototype.componentDidLoad = function () {
        this.options = {
            loop: this.loop || true,
    ...
    DcSwiper.prototype.initSwiper = function () {
        for (var _i = 0, _a = this.wrapper.children; _i < _a.length; _i++) {
            var slide_6 = _a[_i];
            slide_6.classList.add('swiper-slide');
        }
        this.swiper = new Swiper(this.container, Object.assign({}, this.options));
    };
    DcSwiper.prototype.update = function () {
        this.swiper.update();
    };
    DcSwiper.prototype.render = function () {
        var _this = this;
        return (h("div", { class: "swiper-container", ref: function (el) { return _this.container = el; } }, h("div", { class: "swiper-wrapper", ref: function (el) { return _this.wrapper = el; } }, h("slot", null)), h("div", { class: "swiper-button-prev swiper__nav-arrow swiper__nav-arrow-prev", tabindex: "0", role: "button", "aria-label": "Previous slide" }, h("i", { class: "zmdi zmdi-chevron-left swiper__nav-arrow-icon" })), h("div", { class: "swiper-button-next swiper__nav-arrow swiper__nav-arrow-next", tabindex: "0", role: "button", "aria-label": "Next slide" }, h("i", { class: "zmdi zmdi-chevron-right swiper__nav-arrow-icon" }))));
    };
    Object.defineProperty(DcSwiper, "is", {
        get: function () { return "dc-swiper"; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(DcSwiper, "properties", {
        get: function () {
            return {
                "loop": {
                    "type": Boolean,
